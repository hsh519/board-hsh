...
public class MemberController {
    ...
    public String listMemberPagination(@PathVariable int pn, @PathVariable int size, Model model) {
        PageRequestDTO pageRequestDTO = PageRequestDTO.builder().page(2).perPage(3).build();
        PageResultDTO<Member, MemberEntity> resultDTO = memberService.getList(pageRequestDTO);
        if (resultDTO != null) {
...
//    @GetMapping("/list")
//    public String testlistMember(Model model) {
//        List<Member> result = null;
//        if((result = memberService.readList()) != null) {
//            model.addAttribute("list", result);
